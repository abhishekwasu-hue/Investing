...
str_app.markdown("""
    <style>
        ...
        .stock-btn > div > button { background-color: #1a365d !important; border: 2px solid #ecc94b !important; }
        .sector-btn > div > button { background-color: #2b6cb0 !important; border: 2px solid #63b3ed !important; }
...
# (तुमच्या सूचनेनुसार सेल्स आणि नफ्याचा मागील ६ क्वार्टर्सचा अद्ययावत तुलनात्मक वित्तीय तक्ता)
earnings_table_html = """
...
# HTML कव्हर आणि संपूर्ण स्टॉक मसुदा (1-Day आणि 1-Week प्राईस ॲक्शनच्या प्रिंटिंग निर्देशकांसह एम्बेड)
stock_report_html = f"""
<html>
...
# (तुमच्या सूचनेनुसार आंतरराष्ट्रीय घडामोडी, सरकारी धोरण आणि NSDL FPI पैशांच्या प्रवाहाचा ७ पानावरील व्यापक गोषवारा)
